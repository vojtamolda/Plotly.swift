...
public struct ScatterPolar<RData, ThetaData>: Trace, PolarSubplot where RData: Plotable, ThetaData: Plotable {
    ...
    public init(name: String? = nil, mode: Mode? = nil, r: RData? = nil, theta: ThetaData? = nil,
            text: Data<String>? = nil, hoverText: Data<String>? = nil, line: ShapedSmoothDashedLine? = nil,
    ...
    public init(visible: Visible? = nil, showLegend: Bool? = nil, legendGroup: String? = nil,
            ...
            nil, line: ShapedSmoothDashedLine? = nil, connectGaps: Bool? = nil, marker: GradientMarker? =
            nil, clipOnAxis: Bool? = nil, textPosition: TextPosition? = nil, textFont: VariableFont? = nil,
            fill: AreaFill? = nil, fillColor: Color? = nil, hoverInfo: PolarHoverInfo? = nil, hoverOn:
            HoverOn? = nil, hoverTemplate: Data<String>? = nil, selected: Selected? = nil, unselected:
            Unselected? = nil, subplot: Polar = .preset) {
