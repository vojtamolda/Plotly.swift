...
public struct ChoroplethMapbox<LocationsData, ZData>: Trace, MapboxSubplot where LocationsData: Plotable, ZData: Plotable {
    ...
    public init(visible: Visible? = nil, legendGroup: String? = nil, name: String? = nil, uid:
            ...
            transforms: [Transform] = [], uiRevision: Anything? = nil, locations: LocationsData? = nil, z:
            ZData? = nil, geoJson: Anything? = nil, featureIDKey: String? = nil, below: String? = nil, text:
            Data<String>? = nil, hoverText: Data<String>? = nil, marker: Marker? = nil, selected: Selected?
            = nil, unselected: Unselected? = nil, hoverInfo: HoverInfo? = nil, hoverTemplate: Data<String>?
            = nil, showLegend: Bool? = nil, zAuto: Bool? = nil, zMin: Double? = nil, zMax: Double? = nil,
            zMiddle: Double? = nil, colorScale: ColorScale? = nil, autoColorScale: Bool? = nil,
