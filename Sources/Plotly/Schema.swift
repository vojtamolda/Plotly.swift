...
///
/// * One as a one of 100+ [CSS named colors](https://www.quackit.com/css/color/charts/css_color_names_chart.cfm) :
///   ```
...
public enum Color: Encodable {
    ...
    /// Light grey standard CSS color: `#d3d3d3` or `rgb(211,211,211)`.
    public static let lightGrey = Self.CSS("LightGrey", 0xd3d3d3)
    ...
    /// Dark grey standard CSS color: `#a9a9a9` or `rgb(169,169,169)`.
    public static let darkGrey = Self.CSS("DarkGrey", 0xa9a9a9)
    /// Gray standard CSS color: `#808080` or `rgb(128,128,128)`.
    public static let gray = Self.CSS("Gray", 0x808080)
    /// Grey standard CSS color: `#808080` or `rgb(128,128,128)`.
    public static let grey = Self.CSS("Grey", 0x808080)
    /// Dim gray standard CSS color: `#696969` or `rgb(105,105,105)`.
    public static let dimGray = Self.CSS("DimGray", 0x696969)
    /// Dim grey standard CSS color: `#696969` or `rgb(105,105,105)`.
    public static let dimGrey = Self.CSS("DimGrey", 0x696969)
    ...
    /// Light slate grey standard CSS color: `#778899` or `rgb(119,136,153)`.
    public static let lightSlateGrey = Self.CSS("LightSlateGrey", 0x778899)
    /// Slate gray standard CSS color: `#708090` or `rgb(112,128,144)`.
    public static let slateGray = Self.CSS("SlateGray", 0x708090)
    /// Slate grey standard CSS color: `#708090` or `rgb(112,128,144)`.
    public static let slateGrey = Self.CSS("SlateGrey", 0x708090)
    /// Dark slate gray standard CSS color: `#2f4f4f` or `rgb(47,79,79)`.
    public static let darkSlateGray = Self.CSS("DarkSlateGray", 0x2f4f4f)
    /// Dark slate grey standard CSS color: `#2f4f4f` or `rgb(47,79,79)`.
    public static let darkSlateGrey = Self.CSS("DarkSlateGrey", 0x2f4f4f)
...
fileprivate extension ColorList {
    ...
    func createSwatchBar(category: String = "", name: String) -> Bar<[Int], [[String]]> {
        let bar = Bar(
            ...
            orientation: .h,
            marker: Shared.Marker(color: .colors(self))
        )
        return bar
    }
...
public struct ColorScale: Encodable {
    ...
    public enum Brewer {
        ...
        public static let greys: ColorScale = [
            0xffffff,
            0xf0f0f0,
            0xd9d9d9,
            0xbdbdbd,
        ...
        public static func swatch() -> Figure {
            let swatchBars = [
                ...
                Self.greys.createSwatchBar(category: "Sequential<br>(Single-Hue)", name: "greys"),
    ...
    public enum Plotly {
        ...
        public static func swatch() -> Figure {
            let swatchBars = [
                Self.greys.createSwatchBar(category: "JavaScript", name: "greys"),
    ...
    public enum Sequential {
        ...
        /// Sequential _Brewer_ color scale.
        public static let greys = Brewer.greys
        /// Sequential _Brewer_ color scale.
        ...
        public static func swatch() -> Figure {
            let swatchBars = [
                ...
                Self.greys.createSwatchBar(category: "Brewer", name: "greys"),
    ...
    public static func swatch() -> Figure {
        let swatchBars = [
            ...
            Self.greys.createSwatchBar(category: "Sequential", name: "greys"),
    ...
    func createSwatchBar(category: String, name: String) -> Bar<[Int], [[String]]> {
        ...
        return Bar(
            ...
            marker: Shared.Marker(
                color: .array([Double](stride(from: 0.0, to: Double(resolution), by: 1.0))),
                colorScale: self
            )
        )
    }
