public struct Shared {
    ...
    ///   `Scatter3D.DashedColoredLine.ColorBar.tickMode`, `Shared.SymbolicMarker.ColorBar.tickMode`,
    ...
    ///   `Scatter3D.DashedColoredLine.ColorBar.ticks`, `Shared.SymbolicMarker.ColorBar.ticks`,
    ...
    ///   `HeatmapGL.ColorBar.ticks`, `ParallelCoordinates.ColoredLine.ColorBar.ticks`,
    ...
    ///   `Treemap.Marker.ColorBar.showTickPrefix`, `Scatter3D.DashedColoredLine.ColorBar.showTickPrefix`,
    ...
    ///   `Treemap.Marker.ColorBar.showTickSuffix`, `Scatter3D.DashedColoredLine.ColorBar.showTickSuffix`,
    ...
    ///   `Treemap.Marker.ColorBar.exponentFormat`, `Scatter3D.DashedColoredLine.ColorBar.exponentFormat`,
    ...
    ///   `Scatter3D.DashedColoredLine.ColorBar.xAnchor`, `Shared.SymbolicMarker.ColorBar.xAnchor`,
    ...
    ///   `Scatter3D.DashedColoredLine.ColorBar.yAnchor`, `Shared.SymbolicMarker.ColorBar.yAnchor`,
    ...
    ///   `Treemap.Marker.ColorBar.lengthMode`, `Scatter3D.DashedColoredLine.ColorBar.lengthMode`,
    ...
    ///   `Scatter3D.DashedColoredLine.ColorBar.Title.side`, `Shared.SymbolicMarker.ColorBar.Title.side`,
    ...
    /// 
    /// - Note:
    ///   Used by `Shared.SplineSmoothedDashedLine.shape`, `ScatterCarpet.SplineSmoothedDashedLine.shape`,
    ...
    /// 
    /// - Note:
    ///   Used by `Scatter3D.DashedColoredLine.dash`, `ScatterGL.SplineDashedLine.dash`,
    ...
    ///   `Shared.ColorBar.Title.font`, `Scatter.HoverLabel.font`,
    ///   `Shared.GradientMarker.ColorBar.tickFont`, `Shared.GradientMarker.ColorBar.Title.font`,
    ///   `Scatter.textFont`, `Bar.HoverLabel.font`, `Bar.textFont`, `Bar.insideTextFont`,
    ///   `Bar.outSideTextFont`, `Shared.Marker.ColorBar.tickFont`, `Shared.Marker.ColorBar.Title.font`,
    ///   `Box.HoverLabel.font`, `Heatmap.HoverLabel.font`, `Heatmap.ColorBar.tickFont`,
    ///   `Heatmap.ColorBar.Title.font`, `Histogram.HoverLabel.font`,
    ///   `Histogram.Marker.ColorBar.tickFont`, `Histogram.Marker.ColorBar.Title.font`,
    ///   `Histogram2D.HoverLabel.font`, `Histogram2D.ColorBar.tickFont`,
    ///   `Histogram2D.ColorBar.Title.font`, `Histogram2DContour.HoverLabel.font`,
    ///   `Shared.Contours.labelFont`, `Histogram2DContour.ColorBar.tickFont`,
    ///   `Histogram2DContour.ColorBar.Title.font`, `Contour.HoverLabel.font`,
    ///   `Contour.Contours.labelFont`, `Contour.ColorBar.tickFont`, `Contour.ColorBar.Title.font`,
    ///   `ScatterTernary.HoverLabel.font`, `ScatterTernary.GradientMarker.ColorBar.tickFont`,
    ///   `ScatterTernary.GradientMarker.ColorBar.Title.font`, `ScatterTernary.textFont`,
    ///   `Violin.HoverLabel.font`, `Funnel.HoverLabel.font`, `Funnel.textFont`, `Funnel.insideTextFont`,
    ///   `Funnel.outSideTextFont`, `Funnel.Marker.ColorBar.tickFont`,
    ///   `Funnel.Marker.ColorBar.Title.font`, `Waterfall.HoverLabel.font`, `Waterfall.textFont`,
    ///   `Waterfall.insideTextFont`, `Waterfall.outSideTextFont`, `Image.HoverLabel.font`,
    ///   `Pie.HoverLabel.font`, `Pie.textFont`, `Pie.insideTextFont`, `Pie.outSideTextFont`,
    ///   `Pie.Title.font`, `Sunburst.HoverLabel.font`, `Sunburst.Marker.ColorBar.tickFont`,
    ///   `Sunburst.Marker.ColorBar.Title.font`, `Sunburst.textFont`, `Sunburst.insideTextFont`,
    ///   `Sunburst.outSideTextFont`, `Treemap.HoverLabel.font`, `Treemap.Marker.ColorBar.tickFont`,
    ///   `Treemap.Marker.ColorBar.Title.font`, `Treemap.PathBar.textFont`, `Treemap.textFont`,
    ...
    ///   `Scatter3D.HoverLabel.font`, `Scatter3D.DashedColoredLine.ColorBar.tickFont`,
    ///   `Scatter3D.DashedColoredLine.ColorBar.Title.font`, `Shared.SymbolicMarker.ColorBar.tickFont`,
    ///   `Shared.SymbolicMarker.ColorBar.Title.font`, `Scatter3D.textFont`, `Surface.HoverLabel.font`,
    ///   `Surface.ColorBar.tickFont`, `Surface.ColorBar.Title.font`, `Isosurface.HoverLabel.font`,
    ///   `Isosurface.ColorBar.tickFont`, `Isosurface.ColorBar.Title.font`, `Volume.HoverLabel.font`,
    ///   `Volume.ColorBar.tickFont`, `Volume.ColorBar.Title.font`, `Mesh3D.HoverLabel.font`,
    ///   `Mesh3D.ColorBar.tickFont`, `Mesh3D.ColorBar.Title.font`, `Cone.HoverLabel.font`,
    ///   `Cone.ColorBar.tickFont`, `Cone.ColorBar.Title.font`, `StreamTube.HoverLabel.font`,
    ///   `StreamTube.ColorBar.tickFont`, `StreamTube.ColorBar.Title.font`, `ScatterGeo.HoverLabel.font`,
    ///   `ScatterGeo.textFont`, `ScatterGeo.GradientMarker.ColorBar.tickFont`,
    ///   `ScatterGeo.GradientMarker.ColorBar.Title.font`, `Choropleth.HoverLabel.font`,
    ///   `Choropleth.ColorBar.tickFont`, `Choropleth.ColorBar.Title.font`, `ScatterGL.HoverLabel.font`,
    ///   `ScatterGL.textFont`, `ScatterGL.SymbolicMarker.ColorBar.tickFont`,
    ///   `ScatterGL.SymbolicMarker.ColorBar.Title.font`, `ScatterPlotMatrix.HoverLabel.font`,
    ///   `ScatterPlotMatrix.SymbolicMarker.ColorBar.tickFont`,
    ///   `ScatterPlotMatrix.SymbolicMarker.ColorBar.Title.font`, `PointCloud.HoverLabel.font`,
    ///   `HeatmapGL.HoverLabel.font`, `HeatmapGL.ColorBar.tickFont`, `HeatmapGL.ColorBar.Title.font`,
    ///   `ParallelCoordinates.labelFont`, `ParallelCoordinates.tickFont`,
    ///   `ParallelCoordinates.rangeFont`, `ParallelCoordinates.ColoredLine.ColorBar.tickFont`,
    ///   `ParallelCoordinates.ColoredLine.ColorBar.Title.font`, `ParallelCategories.labelFont`,
    ///   `ParallelCategories.tickFont`, `ParallelCategories.SplineColoredLine.ColorBar.tickFont`,
    ///   `ParallelCategories.SplineColoredLine.ColorBar.Title.font`, `ScatterMapbox.HoverLabel.font`,
    ///   `ScatterMapbox.SymbolicMarker.ColorBar.tickFont`,
    ///   `ScatterMapbox.SymbolicMarker.ColorBar.Title.font`, `ScatterMapbox.textFont`,
    ///   `ChoroplethMapbox.HoverLabel.font`, `ChoroplethMapbox.ColorBar.tickFont`,
    ///   `ChoroplethMapbox.ColorBar.Title.font`, `DensityMapbox.HoverLabel.font`,
    ///   `DensityMapbox.ColorBar.tickFont`, `DensityMapbox.ColorBar.Title.font`,
    ///   `Sankey.HoverLabel.font`, `Sankey.textFont`, `Sankey.Node.HoverLabel.font`,
    ///   `Sankey.Link.HoverLabel.font`, `Indicator.Title.font`, `Indicator.Number.font`,
    ///   `Indicator.Delta.font`, `Indicator.Gauge.Axis.tickFont`, `Table.HoverLabel.font`,
    ///   `Table.Header.font`, `Table.Cells.font`, `Carpet.AAxis.Title.font`, `Carpet.AAxis.tickFont`,
    ///   `Carpet.BAxis.Title.font`, `Carpet.BAxis.tickFont`, `Carpet.font`,
    ///   `ScatterCarpet.HoverLabel.font`, `ScatterCarpet.GradientMarker.ColorBar.tickFont`,
    ///   `ScatterCarpet.GradientMarker.ColorBar.Title.font`, `ScatterCarpet.textFont`,
    ///   `ContourCarpet.Contours.labelFont`, `ContourCarpet.ColorBar.tickFont`,
    ///   `ContourCarpet.ColorBar.Title.font`, `OHLC.HoverLabel.font`, `Candlestick.HoverLabel.font`,
    ///   `ScatterPolar.HoverLabel.font`, `ScatterPolar.GradientMarker.ColorBar.tickFont`,
    ///   `ScatterPolar.GradientMarker.ColorBar.Title.font`, `ScatterPolar.textFont`,
    ///   `ScatterPolarGL.HoverLabel.font`, `ScatterPolarGL.SymbolicMarker.ColorBar.tickFont`,
    ///   `ScatterPolarGL.SymbolicMarker.ColorBar.Title.font`, `ScatterPolarGL.textFont`,
    ///   `BarPolar.HoverLabel.font`, `BarPolar.Marker.ColorBar.tickFont`,
    ...
    ///   `Scatter3D.DashedColoredLine.colorBar`, `Shared.SymbolicMarker.colorBar`, `Surface.colorBar`,
    ...
    ///   `HeatmapGL.colorBar`, `ParallelCoordinates.ColoredLine.colorBar`,
    ///   `ParallelCategories.SplineColoredLine.colorBar`, `ScatterMapbox.SymbolicMarker.colorBar`,
    ...
    ///   `Waterfall.Decreasing.Marker.line`, `Waterfall.Totals.Marker.line`, `Pie.Marker.line`,
    ///   `Sunburst.Marker.line`, `Treemap.Marker.line`, `FunnelArea.Marker.line`,
    ///   `Choropleth.Marker.line`, `ScatterMapbox.line`, `ChoroplethMapbox.Marker.line`,
    ///   `Sankey.Node.line`, `Sankey.Link.line`, `Indicator.Gauge.Bar.line`, `Indicator.Gauge.Step.line`,
    ///   `Indicator.Gauge.Threshold.line`, `Table.Header.line`, `Table.Cells.line`.
