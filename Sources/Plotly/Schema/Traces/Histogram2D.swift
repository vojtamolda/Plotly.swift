...
public struct Histogram2D<XData, YData, ZData>: Trace where XData: Plotable, YData: Plotable, ZData: Plotable {
    ...
    /// Creates `Histogram2D` object from the most frequently used properties.
    /// 
    /// - Parameters:
    ...
    public init(name: String? = nil, x: XData? = nil, y: YData? = nil, z: ZData? = nil, marker:
            Marker? = nil, colorScale: ColorScale? = nil, reverseScale: Bool? = nil) {
        self.name = name
        self.x = x
        self.y = y
        self.z = z
    ...
    /// Creates `Histogram2D` object with specified properties.
    /// 
    /// - Parameters:
    ...
    public init(visible: Shared.Visible? = nil, opacity: Double? = nil, name: String? = nil, uid:
            ...
            YData? = nil, z: ZData? = nil, marker: Marker? = nil, normalization: Shared.Normalization? =
            nil, binningFunction: Shared.BinningFunction? = nil, xNumBins: Int? = nil, xBins: Shared.Bins? =
            nil, yNumBins: Int? = nil, yBins: Shared.Bins? = nil, xAutoBin: Bool? = nil, yAutoBin: Bool? =
            nil, binGroup: String? = nil, xBinGroup: String? = nil, yBinGroup: String? = nil, xGap: Double?
            = nil, yGap: Double? = nil, zSmooth: ZSmooth? = nil, zHoverFormat: String? = nil, hoverTemplate:
            ArrayOrString? = nil, zAuto: Bool? = nil, zMin: Double? = nil, zMax: Double? = nil, zMiddle:
