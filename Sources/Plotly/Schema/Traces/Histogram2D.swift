...
public struct Histogram2D: Trace {
    ...
    public init(visible: Visible? = nil, opacity: Double? = nil, name: String? = nil, uid: String? = nil, ids: [Double]? = nil, customdata: [Double]? = nil, meta: Anything? = nil, hoverinfo: Hoverinfo? = nil, hoverlabel: Hoverlabel? = nil, stream: Stream? = nil, transforms: Transforms? = nil, uirevision: Anything? = nil, x: [Double]? = nil, y: [Double]? = nil, z: [Double]? = nil, marker: Marker? = nil, histnorm: Histnorm? = nil, histfunc: Histfunc? = nil, nbinsx: Int? = nil, xbins: Xbins? = nil, nbinsy: Int? = nil, ybins: Ybins? = nil, autobinx: Bool? = nil, autobiny: Bool? = nil, bingroup: String? = nil, xbingroup: String? = nil, ybingroup: String? = nil, xgap: Double? = nil, ygap: Double? = nil, zsmooth: Zsmooth? = nil, zhoverformat: String? = nil, hovertemplate: String? = nil, zauto: Bool? = nil, zmin: Double? = nil, zmax: Double? = nil, zmid: Double? = nil, colorscale: ColorScale? = nil, autocolorscale: Bool? = nil, reversescale: Bool? = nil, showscale: Bool? = nil, colorbar: Colorbar? = nil, coloraxis: SubplotID? = nil, xcalendar: Xcalendar? = nil, ycalendar: Ycalendar? = nil, xaxis: SubplotID? = nil, yaxis: SubplotID? = nil, idssrc: String? = nil, customdatasrc: String? = nil, metasrc: String? = nil, hoverinfosrc: String? = nil, xsrc: String? = nil, ysrc: String? = nil, zsrc: String? = nil, hovertemplatesrc: String? = nil) {
