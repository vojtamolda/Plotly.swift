        ...
        public struct Items: Encodable {
            public struct Dimension: Encodable {
                ...
                public struct Axis: Encodable {
                    ...
                    public init(type: AxisType? = nil, matches: Bool? = nil) {
                        self.type = type
                ...
                public init(visible: Bool? = nil, label: String? = nil, values: [Double]? = nil, axis: Axis? = nil, name: String? = nil, templateitemname: String? = nil, valuessrc: String? = nil) {
