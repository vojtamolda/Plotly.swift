...
public struct OHLC<XData, OpenData, HighData, LowData, CloseData>: Trace where XData: Plotable, OpenData: Plotable, HighData: Plotable, LowData: Plotable, CloseData: Plotable {
    ...
    public init(name: String? = nil, x: XData? = nil, open: OpenData? = nil, high: HighData? = nil,
            low: LowData? = nil, close: CloseData? = nil, line: DashedLine? = nil, text: ArrayOrString? =
            nil, hoverText: ArrayOrString? = nil) {
        self.name = name
        self.x = x
        self.open = open
        self.high = high
    ...
    public init(visible: Shared.Visible? = nil, showLegend: Bool? = nil, legendGroup: String? = nil,
            ...
            hoverText: ArrayOrString? = nil, tickWidth: Double? = nil, hoverLabel: HoverLabel? = nil,
