...
public struct Sunburst: Trace {
    ...
    public struct Marker: Encodable {
        ...
        public init(colors: [Double]? = nil, line: Line? = nil, cauto: Bool? = nil, cmin: Double? = nil, cmax: Double? = nil, cmid: Double? = nil, colorscale: ColorScale? = nil, autocolorscale: Bool? = nil, reversescale: Bool? = nil, showscale: Bool? = nil, colorbar: Colorbar? = nil, coloraxis: SubplotID? = nil, colorssrc: String? = nil) {
            self.colors = colors
            self.line = line
            self.cauto = cauto
            self.cmin = cmin
