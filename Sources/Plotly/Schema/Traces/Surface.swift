...
public struct Surface: Trace {
    ...
    public struct _Deprecated: Encodable {
        ...
        public struct Zauto: Encodable {
            public init() {
            }
        }
        /// Obsolete. Use `cauto` instead.
        public var zauto: Zauto?
    
        /// Obsolete. Use `cmin` instead.
        public struct Zmin: Encodable {
            public init() {
            }
        }
        /// Obsolete. Use `cmin` instead.
        public var zmin: Zmin?
    
        /// Obsolete. Use `cmax` instead.
        public struct Zmax: Encodable {
            public init() {
            }
        }
        /// Obsolete. Use `cmax` instead.
        public var zmax: Zmax?
    
        public init(zauto: Zauto? = nil, zmin: Zmin? = nil, zmax: Zmax? = nil) {
            self.zauto = zauto
            self.zmin = zmin
            self.zmax = zmax
        }
    ...
    public var surfacecolorsrc: String?

    /// Sets the source reference on plot.ly for  hoverinfo .
    public var hoverinfosrc: String?

    public init(visible: Visible? = nil, name: String? = nil, uid: String? = nil, ids: [Double]? = nil, customdata: [Double]? = nil, meta: Anything? = nil, hoverlabel: Hoverlabel? = nil, stream: Stream? = nil, uirevision: Anything? = nil, z: [Double]? = nil, x: [Double]? = nil, y: [Double]? = nil, text: String? = nil, hovertext: String? = nil, hovertemplate: String? = nil, connectgaps: Bool? = nil, surfacecolor: [Double]? = nil, cauto: Bool? = nil, cmin: Double? = nil, cmax: Double? = nil, cmid: Double? = nil, colorscale: ColorScale? = nil, autocolorscale: Bool? = nil, reversescale: Bool? = nil, showscale: Bool? = nil, colorbar: Colorbar? = nil, coloraxis: SubplotID? = nil, contours: Contours? = nil, hidesurface: Bool? = nil, lightposition: Lightposition? = nil, lighting: Lighting? = nil, opacity: Double? = nil, _deprecated: _Deprecated? = nil, hoverinfo: Hoverinfo? = nil, xcalendar: Xcalendar? = nil, ycalendar: Ycalendar? = nil, zcalendar: Zcalendar? = nil, scene: SubplotID? = nil, idssrc: String? = nil, customdatasrc: String? = nil, metasrc: String? = nil, zsrc: String? = nil, xsrc: String? = nil, ysrc: String? = nil, textsrc: String? = nil, hovertextsrc: String? = nil, hovertemplatesrc: String? = nil, surfacecolorsrc: String? = nil, hoverinfosrc: String? = nil) {
