...
public struct Scatter: Trace {
    ...
    public enum Groupnorm: String, Encodable {
        case none
        case fraction
        case percent
    }
    ...
    public init(visible: Visible? = nil, showlegend: Bool? = nil, legendgroup: String? = nil, opacity: Double? = nil, name: String? = nil, uid: String? = nil, ids: [Double]? = nil, customdata: [Double]? = nil, meta: Anything? = nil, selectedpoints: Anything? = nil, hoverinfo: Hoverinfo? = nil, hoverlabel: Hoverlabel? = nil, stream: Stream? = nil, transforms: Transforms? = nil, uirevision: Anything? = nil, x: [Double]? = nil, x0: Anything? = nil, dx: Double? = nil, y: [Double]? = nil, y0: Anything? = nil, dy: Double? = nil, stackgroup: String? = nil, orientation: Orientation? = nil, groupnorm: Groupnorm? = nil, stackgaps: Stackgaps? = nil, text: String? = nil, texttemplate: String? = nil, hovertext: String? = nil, mode: Mode? = nil, hoveron: Hoveron? = nil, hovertemplate: String? = nil, line: Line? = nil, connectgaps: Bool? = nil, cliponaxis: Bool? = nil, fill: Fill? = nil, fillcolor: Color? = nil, marker: Marker? = nil, selected: Selected? = nil, unselected: Unselected? = nil, textposition: Textposition? = nil, textfont: Textfont? = nil, r: [Double]? = nil, t: [Double]? = nil, error_x: Error_X? = nil, error_y: Error_Y? = nil, xcalendar: Xcalendar? = nil, ycalendar: Ycalendar? = nil, xaxis: SubplotID? = nil, yaxis: SubplotID? = nil, idssrc: String? = nil, customdatasrc: String? = nil, metasrc: String? = nil, hoverinfosrc: String? = nil, xsrc: String? = nil, ysrc: String? = nil, textsrc: String? = nil, texttemplatesrc: String? = nil, hovertextsrc: String? = nil, hovertemplatesrc: String? = nil, textpositionsrc: String? = nil, rsrc: String? = nil, tsrc: String? = nil) {
        self.visible = visible
