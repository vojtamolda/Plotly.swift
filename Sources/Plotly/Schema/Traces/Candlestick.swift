...
public struct Candlestick: Trace {
    ...
    public struct Increasing: Encodable {
        ...
        public init(line: Line2? = nil, fillColor: Color? = nil) {
            self.line = line
