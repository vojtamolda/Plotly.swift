...
public struct Isosurface<XData, YData, ZData, ValueData>: Trace where XData: Plotable, YData: Plotable, ZData: Plotable, ValueData: Plotable {
    ...
    public init(visible: Shared.Visible? = nil, name: String? = nil, uid: String? = nil, ids:
            ...
            caps: Caps? = nil, text: ArrayOrString? = nil, hoverText: ArrayOrString? = nil, hoverTemplate:
            ArrayOrString? = nil, cAuto: Bool? = nil, cMin: Double? = nil, cMax: Double? = nil, cMiddle:
            ...
            nil, flatShading: Bool? = nil, contour: Shared.ContourHover? = nil, hoverInfo: Shared.HoverInfo?
            = nil, scene: SubPlotID? = nil) {
