...
public struct ScatterCarpet<AData, BData>: Trace where AData: Plotable, BData: Plotable {
    ...
    public init(name: String? = nil, a: AData? = nil, b: BData? = nil, mode: Shared.Mode? = nil,
            text: ArrayOrString? = nil, hoverText: ArrayOrString? = nil, line:
    ...
    public init(visible: Shared.Visible? = nil, showLegend: Bool? = nil, legendGroup: String? = nil,
            ...
            b: BData? = nil, mode: Shared.Mode? = nil, text: ArrayOrString? = nil, textTemplate:
            ArrayOrString? = nil, hoverText: ArrayOrString? = nil, line: Shared.SplineSmoothedDashedLine? =
            ...
            hoverOn: Shared.HoverOn? = nil, hoverTemplate: ArrayOrString? = nil, xAxis: SubPlotID? = nil,
            yAxis: SubPlotID? = nil) {
