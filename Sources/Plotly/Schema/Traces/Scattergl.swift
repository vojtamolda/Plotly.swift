...
public struct Scattergl: Trace {
    ...
    public struct Marker: Encodable {
        ...
        public struct Line: Encodable {
            ...
            public init(color: Color? = nil, cauto: Bool? = nil, cmin: Double? = nil, cmax: Double? = nil, cmid: Double? = nil, colorscale: ColorScale? = nil, autocolorscale: Bool? = nil, reversescale: Bool? = nil, coloraxis: SubplotID? = nil, width: Double? = nil, colorsrc: String? = nil, widthsrc: String? = nil) {
                self.color = color
                self.cauto = cauto
                self.cmin = cmin
                self.cmax = cmax
        ...
        public init(color: Color? = nil, cauto: Bool? = nil, cmin: Double? = nil, cmax: Double? = nil, cmid: Double? = nil, colorscale: ColorScale? = nil, autocolorscale: Bool? = nil, reversescale: Bool? = nil, showscale: Bool? = nil, colorbar: Colorbar? = nil, coloraxis: SubplotID? = nil, symbol: Symbol? = nil, size: Double? = nil, sizeref: Double? = nil, sizemin: Double? = nil, sizemode: Sizemode? = nil, opacity: Double? = nil, line: Line? = nil, colorsrc: String? = nil, symbolsrc: String? = nil, sizesrc: String? = nil, opacitysrc: String? = nil) {
            self.color = color
            self.cauto = cauto
            self.cmin = cmin
            self.cmax = cmax
    ...
    public init(visible: Visible? = nil, showlegend: Bool? = nil, legendgroup: String? = nil, name: String? = nil, uid: String? = nil, ids: [Double]? = nil, customdata: [Double]? = nil, meta: Anything? = nil, selectedpoints: Anything? = nil, hoverinfo: Hoverinfo? = nil, hoverlabel: Hoverlabel? = nil, stream: Stream? = nil, transforms: Transforms? = nil, uirevision: Anything? = nil, x: [Double]? = nil, x0: Anything? = nil, dx: Double? = nil, y: [Double]? = nil, y0: Anything? = nil, dy: Double? = nil, text: String? = nil, hovertext: String? = nil, textposition: Textposition? = nil, textfont: Textfont? = nil, mode: Mode? = nil, line: Line? = nil, marker: Marker? = nil, connectgaps: Bool? = nil, fill: Fill? = nil, fillcolor: Color? = nil, selected: Selected? = nil, unselected: Unselected? = nil, opacity: Double? = nil, hovertemplate: String? = nil, texttemplate: String? = nil, error_x: Error_X? = nil, error_y: Error_Y? = nil, xcalendar: Xcalendar? = nil, ycalendar: Ycalendar? = nil, xaxis: SubplotID? = nil, yaxis: SubplotID? = nil, idssrc: String? = nil, customdatasrc: String? = nil, metasrc: String? = nil, hoverinfosrc: String? = nil, xsrc: String? = nil, ysrc: String? = nil, textsrc: String? = nil, hovertextsrc: String? = nil, textpositionsrc: String? = nil, hovertemplatesrc: String? = nil, texttemplatesrc: String? = nil) {
        self.visible = visible
