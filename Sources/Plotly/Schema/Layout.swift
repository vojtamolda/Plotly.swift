public struct Layout: Encodable {
    ...
    public struct Title: Encodable {
        ...
        public enum Xref: String, Encodable {
            case container
            case paper
        }
        /// Sets the container `x` refers to. *container* spans the entire `width` of the plot. *paper* refers to the width of the plotting area only.
        public var xref: Xref?
    
        /// Sets the container `y` refers to. *container* spans the entire `height` of the plot. *paper* refers to the height of the plotting area only.
        public enum Yref: String, Encodable {
            case container
            case paper
        }
        /// Sets the container `y` refers to. *container* spans the entire `height` of the plot. *paper* refers to the height of the plotting area only.
        public var yref: Yref?
        ...
        public init(text: String? = nil, font: Font? = nil, xref: Xref? = nil, yref: Yref? = nil, x: Double? = nil, y: Double? = nil, xanchor: Xanchor? = nil, yanchor: Yanchor? = nil, pad: Pad? = nil) {
            self.text = text
            self.font = font
            self.xref = xref
            self.yref = yref
    ...
    public struct Margin: Encodable {
        ...
        public init(l: Double? = nil, r: Double? = nil, t: Double? = nil, b: Double? = nil, pad: Double? = nil, autoexpand: Bool? = nil) {
            self.l = l
            self.r = r
            self.t = t
            self.b = b
    ...
    public var paper_bgcolor: Color?

    /// Sets the color of plotting area in-between x and y axes.
    public var plot_bgcolor: Color?
    ...
    public struct Modebar: Encodable {
        ...
        public init(orientation: Orientation? = nil, bgcolor: Color? = nil, color: Color? = nil, activecolor: Color? = nil, uirevision: Anything? = nil) {
    ...
    public struct Hoverlabel: Encodable {
        ...
        public init(bgcolor: Color? = nil, bordercolor: Color? = nil, font: Font? = nil, align: Align? = nil, namelength: Int? = nil) {
            self.bgcolor = bgcolor
    ...
    public struct Xaxis: Encodable {
        ...
        public struct Rangeslider: Encodable {
            ...
            public init(bgcolor: Color? = nil, bordercolor: Color? = nil, borderwidth: Int? = nil, autorange: Bool? = nil, range: InfoArray? = nil, thickness: Double? = nil, visible: Bool? = nil, yaxis: Yaxis? = nil) {
                self.bgcolor = bgcolor
                self.bordercolor = bordercolor
        ...
        public struct Rangeselector: Encodable {
            ...
            public init(visible: Bool? = nil, buttons: Buttons? = nil, x: Double? = nil, xanchor: Xanchor? = nil, y: Double? = nil, yanchor: Yanchor? = nil, font: Font? = nil, bgcolor: Color? = nil, activecolor: Color? = nil, bordercolor: Color? = nil, borderwidth: Double? = nil) {
                self.visible = visible
        ...
        public init(visible: Bool? = nil, color: Color? = nil, title: Title? = nil, type: AxisType? = nil, autorange: Autorange? = nil, rangemode: Rangemode? = nil, range: InfoArray? = nil, fixedrange: Bool? = nil, scaleanchor: Scaleanchor? = nil, scaleratio: Double? = nil, constrain: Constrain? = nil, constraintoward: Constraintoward? = nil, matches: Matches? = nil, tickmode: Tickmode? = nil, nticks: Int? = nil, tick0: Anything? = nil, dtick: Anything? = nil, tickvals: [Double]? = nil, ticktext: [Double]? = nil, ticks: Ticks? = nil, tickson: Tickson? = nil, mirror: Mirror? = nil, ticklen: Double? = nil, tickwidth: Double? = nil, tickcolor: Color? = nil, showticklabels: Bool? = nil, automargin: Bool? = nil, showspikes: Bool? = nil, spikecolor: Color? = nil, spikethickness: Double? = nil, spikedash: String? = nil, spikemode: Spikemode? = nil, spikesnap: Spikesnap? = nil, tickfont: Tickfont? = nil, tickangle: Angle? = nil, tickprefix: String? = nil, showtickprefix: Showtickprefix? = nil, ticksuffix: String? = nil, showticksuffix: Showticksuffix? = nil, showexponent: Showexponent? = nil, exponentformat: Exponentformat? = nil, separatethousands: Bool? = nil, tickformat: String? = nil, tickformatstops: Tickformatstops? = nil, hoverformat: String? = nil, showline: Bool? = nil, linecolor: Color? = nil, linewidth: Double? = nil, showgrid: Bool? = nil, gridcolor: Color? = nil, gridwidth: Double? = nil, zeroline: Bool? = nil, zerolinecolor: Color? = nil, zerolinewidth: Double? = nil, showdividers: Bool? = nil, dividercolor: Color? = nil, dividerwidth: Double? = nil, anchor: Anchor? = nil, side: Side? = nil, overlaying: Overlaying? = nil, layer: Layer? = nil, domain: InfoArray? = nil, position: Double? = nil, categoryorder: Categoryorder? = nil, categoryarray: [Double]? = nil, uirevision: Anything? = nil, _deprecated: _Deprecated? = nil, rangeslider: Rangeslider? = nil, rangeselector: Rangeselector? = nil, calendar: Calendar? = nil, tickvalssrc: String? = nil, ticktextsrc: String? = nil, categoryarraysrc: String? = nil) {
            self.visible = visible
            self.color = color
            self.title = title
            self.type = type
    ...
    public struct Yaxis: Encodable {
        ...
        public init(visible: Bool? = nil, color: Color? = nil, title: Title? = nil, type: AxisType? = nil, autorange: Autorange? = nil, rangemode: Rangemode? = nil, range: InfoArray? = nil, fixedrange: Bool? = nil, scaleanchor: Scaleanchor? = nil, scaleratio: Double? = nil, constrain: Constrain? = nil, constraintoward: Constraintoward? = nil, matches: Matches? = nil, tickmode: Tickmode? = nil, nticks: Int? = nil, tick0: Anything? = nil, dtick: Anything? = nil, tickvals: [Double]? = nil, ticktext: [Double]? = nil, ticks: Ticks? = nil, tickson: Tickson? = nil, mirror: Mirror? = nil, ticklen: Double? = nil, tickwidth: Double? = nil, tickcolor: Color? = nil, showticklabels: Bool? = nil, automargin: Bool? = nil, showspikes: Bool? = nil, spikecolor: Color? = nil, spikethickness: Double? = nil, spikedash: String? = nil, spikemode: Spikemode? = nil, spikesnap: Spikesnap? = nil, tickfont: Tickfont? = nil, tickangle: Angle? = nil, tickprefix: String? = nil, showtickprefix: Showtickprefix? = nil, ticksuffix: String? = nil, showticksuffix: Showticksuffix? = nil, showexponent: Showexponent? = nil, exponentformat: Exponentformat? = nil, separatethousands: Bool? = nil, tickformat: String? = nil, tickformatstops: Tickformatstops? = nil, hoverformat: String? = nil, showline: Bool? = nil, linecolor: Color? = nil, linewidth: Double? = nil, showgrid: Bool? = nil, gridcolor: Color? = nil, gridwidth: Double? = nil, zeroline: Bool? = nil, zerolinecolor: Color? = nil, zerolinewidth: Double? = nil, showdividers: Bool? = nil, dividercolor: Color? = nil, dividerwidth: Double? = nil, anchor: Anchor? = nil, side: Side? = nil, overlaying: Overlaying? = nil, layer: Layer? = nil, domain: InfoArray? = nil, position: Double? = nil, categoryorder: Categoryorder? = nil, categoryarray: [Double]? = nil, uirevision: Anything? = nil, _deprecated: _Deprecated? = nil, calendar: Calendar? = nil, tickvalssrc: String? = nil, ticktextsrc: String? = nil, categoryarraysrc: String? = nil) {
            self.visible = visible
            self.color = color
            self.title = title
            self.type = type
    ...
    public struct Ternary: Encodable {
        ...
        public struct Aaxis: Encodable {
            ...
            public init(title: Title? = nil, color: Color? = nil, tickmode: Tickmode? = nil, nticks: Int? = nil, tick0: Anything? = nil, dtick: Anything? = nil, tickvals: [Double]? = nil, ticktext: [Double]? = nil, ticks: Ticks? = nil, ticklen: Double? = nil, tickwidth: Double? = nil, tickcolor: Color? = nil, showticklabels: Bool? = nil, showtickprefix: Showtickprefix? = nil, tickprefix: String? = nil, showticksuffix: Showticksuffix? = nil, ticksuffix: String? = nil, showexponent: Showexponent? = nil, exponentformat: Exponentformat? = nil, separatethousands: Bool? = nil, tickfont: Tickfont? = nil, tickangle: Angle? = nil, tickformat: String? = nil, tickformatstops: Tickformatstops? = nil, hoverformat: String? = nil, showline: Bool? = nil, linecolor: Color? = nil, linewidth: Double? = nil, showgrid: Bool? = nil, gridcolor: Color? = nil, gridwidth: Double? = nil, layer: Layer? = nil, min: Double? = nil, _deprecated: _Deprecated? = nil, uirevision: Anything? = nil, tickvalssrc: String? = nil, ticktextsrc: String? = nil) {
                self.title = title
                self.color = color
                self.tickmode = tickmode
                self.nticks = nticks
        ...
        public init(domain: Domain? = nil, bgcolor: Color? = nil, sum: Double? = nil, aaxis: Aaxis? = nil, baxis: Baxis? = nil, caxis: Caxis? = nil, uirevision: Anything? = nil) {
            self.domain = domain
            self.bgcolor = bgcolor
            self.sum = sum
            self.aaxis = aaxis
    ...
    public struct Scene: Encodable {
        ...
        public struct Xaxis: Encodable {
            ...
            public init(visible: Bool? = nil, showspikes: Bool? = nil, spikesides: Bool? = nil, spikethickness: Double? = nil, spikecolor: Color? = nil, showbackground: Bool? = nil, backgroundcolor: Color? = nil, showaxeslabels: Bool? = nil, color: Color? = nil, categoryorder: Categoryorder? = nil, categoryarray: [Double]? = nil, title: Title? = nil, type: AxisType? = nil, autorange: Autorange? = nil, rangemode: Rangemode? = nil, range: InfoArray? = nil, tickmode: Tickmode? = nil, nticks: Int? = nil, tick0: Anything? = nil, dtick: Anything? = nil, tickvals: [Double]? = nil, ticktext: [Double]? = nil, ticks: Ticks? = nil, mirror: Mirror? = nil, ticklen: Double? = nil, tickwidth: Double? = nil, tickcolor: Color? = nil, showticklabels: Bool? = nil, tickfont: Tickfont? = nil, tickangle: Angle? = nil, tickprefix: String? = nil, showtickprefix: Showtickprefix? = nil, ticksuffix: String? = nil, showticksuffix: Showticksuffix? = nil, showexponent: Showexponent? = nil, exponentformat: Exponentformat? = nil, separatethousands: Bool? = nil, tickformat: String? = nil, tickformatstops: Tickformatstops? = nil, hoverformat: String? = nil, showline: Bool? = nil, linecolor: Color? = nil, linewidth: Double? = nil, showgrid: Bool? = nil, gridcolor: Color? = nil, gridwidth: Double? = nil, zeroline: Bool? = nil, zerolinecolor: Color? = nil, zerolinewidth: Double? = nil, _deprecated: _Deprecated? = nil, calendar: Calendar? = nil, categoryarraysrc: String? = nil, tickvalssrc: String? = nil, ticktextsrc: String? = nil) {
                self.visible = visible
                self.showspikes = showspikes
        ...
        public struct Annotations: Encodable {
            public struct Items: Encodable {
                public struct Annotation: Encodable {
                    ...
                    public enum Valign: String, Encodable {
                        case top
                        case middle
                        case bottom
                    }
                    ...
                    public struct Hoverlabel: Encodable {
                        ...
                        public init(bgcolor: Color? = nil, bordercolor: Color? = nil, font: Font? = nil) {
                            self.bgcolor = bgcolor
                            self.bordercolor = bordercolor
                            self.font = font
                        }
        ...
        public init(bgcolor: Color? = nil, camera: Camera? = nil, domain: Domain? = nil, aspectmode: Aspectmode? = nil, aspectratio: Aspectratio? = nil, xaxis: Xaxis? = nil, yaxis: Yaxis? = nil, zaxis: Zaxis? = nil, dragmode: Dragmode? = nil, hovermode: Hovermode? = nil, uirevision: Anything? = nil, _deprecated: _Deprecated? = nil, annotations: Annotations? = nil) {
            self.bgcolor = bgcolor
            self.camera = camera
            self.domain = domain
    ...
    public struct Geo: Encodable {
        ...
        public struct Projection: Encodable {
            ...
            public struct Rotation: Encodable {
                ...
                public init(lon: Double? = nil, lat: Double? = nil, roll: Double? = nil) {
                    self.lon = lon
                    self.lat = lat
                    self.roll = roll
                }
            ...
            public init(type: AxisType? = nil, rotation: Rotation? = nil, parallels: InfoArray? = nil, scale: Double? = nil) {
                self.type = type
        ...
        public struct Lonaxis: Encodable {
        ...
        public var lonaxis: Lonaxis?
    
        public struct Lataxis: Encodable {
            /// Sets the range of this axis (in degrees), sets the map's clipped coordinates.
            public var range: InfoArray?
        ...
        public var lataxis: Lataxis?
    
        /// Controls persistence of user-driven changes in the view (projection and center). Defaults to `layout.uirevision`.
        public var uirevision: Anything?
    
        public init(domain: Domain? = nil, resolution: Resolution? = nil, scope: Scope? = nil, projection: Projection? = nil, center: Center? = nil, showcoastlines: Bool? = nil, coastlinecolor: Color? = nil, coastlinewidth: Double? = nil, showland: Bool? = nil, landcolor: Color? = nil, showocean: Bool? = nil, oceancolor: Color? = nil, showlakes: Bool? = nil, lakecolor: Color? = nil, showrivers: Bool? = nil, rivercolor: Color? = nil, riverwidth: Double? = nil, showcountries: Bool? = nil, countrycolor: Color? = nil, countrywidth: Double? = nil, showsubunits: Bool? = nil, subunitcolor: Color? = nil, subunitwidth: Double? = nil, showframe: Bool? = nil, framecolor: Color? = nil, framewidth: Double? = nil, bgcolor: Color? = nil, lonaxis: Lonaxis? = nil, lataxis: Lataxis? = nil, uirevision: Anything? = nil) {
            self.domain = domain
            ...
            public struct Items: Encodable {
                public struct Layer: Encodable {
                    ...
                    public struct Line: Encodable {
                        ...
                        public var dashsrc: String?
                    
                        public init(width: Double? = nil, dash: [Double]? = nil, dashsrc: String? = nil) {
                            self.width = width
                            self.dash = dash
                            self.dashsrc = dashsrc
                        }
                    }
                    ...
                    public init(visible: Bool? = nil, sourcetype: Sourcetype? = nil, source: Anything? = nil, sourcelayer: String? = nil, sourceattribution: String? = nil, type: AxisType? = nil, coordinates: Anything? = nil, below: String? = nil, color: Color? = nil, opacity: Double? = nil, minzoom: Double? = nil, maxzoom: Double? = nil, circle: Circle? = nil, line: Line? = nil, fill: Fill? = nil, symbol: Symbol? = nil, name: String? = nil, templateitemname: String? = nil) {
                        self.visible = visible
    ...
    public struct Polar: Encodable {
        ...
        public struct Radialaxis: Encodable {
            ...
            public init(visible: Bool? = nil, type: AxisType? = nil, autorange: Autorange? = nil, rangemode: Rangemode? = nil, range: InfoArray? = nil, categoryorder: Categoryorder? = nil, categoryarray: [Double]? = nil, angle: Angle? = nil, side: Side? = nil, title: Title? = nil, hoverformat: String? = nil, uirevision: Anything? = nil, _deprecated: _Deprecated? = nil, color: Color? = nil, showline: Bool? = nil, linecolor: Color? = nil, linewidth: Double? = nil, showgrid: Bool? = nil, gridcolor: Color? = nil, gridwidth: Double? = nil, tickmode: Tickmode? = nil, nticks: Int? = nil, tick0: Anything? = nil, dtick: Anything? = nil, tickvals: [Double]? = nil, ticktext: [Double]? = nil, ticks: Ticks? = nil, ticklen: Double? = nil, tickwidth: Double? = nil, tickcolor: Color? = nil, showticklabels: Bool? = nil, showtickprefix: Showtickprefix? = nil, tickprefix: String? = nil, showticksuffix: Showticksuffix? = nil, ticksuffix: String? = nil, showexponent: Showexponent? = nil, exponentformat: Exponentformat? = nil, separatethousands: Bool? = nil, tickfont: Tickfont? = nil, tickangle: Angle? = nil, tickformat: String? = nil, tickformatstops: Tickformatstops? = nil, layer: Layer? = nil, calendar: Calendar? = nil, categoryarraysrc: String? = nil, tickvalssrc: String? = nil, ticktextsrc: String? = nil) {
                self.visible = visible
                self.type = type
                self.autorange = autorange
                self.rangemode = rangemode
        ...
        public init(domain: Domain? = nil, sector: InfoArray? = nil, hole: Double? = nil, bgcolor: Color? = nil, radialaxis: Radialaxis? = nil, angularaxis: Angularaxis? = nil, gridshape: Gridshape? = nil, uirevision: Anything? = nil) {
            self.domain = domain
            self.sector = sector
            self.hole = hole
            self.bgcolor = bgcolor
    ...
    public struct Radialaxis: Encodable {
        ...
        public init(range: InfoArray? = nil, domain: InfoArray? = nil, orientation: Double? = nil, showline: Bool? = nil, showticklabels: Bool? = nil, tickorientation: Tickorientation? = nil, ticklen: Double? = nil, tickcolor: Color? = nil, ticksuffix: String? = nil, endpadding: Double? = nil, visible: Bool? = nil) {
            self.range = range
            self.domain = domain
            self.orientation = orientation
            self.showline = showline
    ...
    public struct Angularaxis: Encodable {
        ...
        public init(range: InfoArray? = nil, domain: InfoArray? = nil, showline: Bool? = nil, showticklabels: Bool? = nil, tickorientation: Tickorientation? = nil, ticklen: Double? = nil, tickcolor: Color? = nil, ticksuffix: String? = nil, endpadding: Double? = nil, visible: Bool? = nil) {
            self.range = range
            self.domain = domain
            self.showline = showline
            self.showticklabels = showticklabels
    ...
    public struct Legend: Encodable {
        ...
        public init(bgcolor: Color? = nil, bordercolor: Color? = nil, borderwidth: Double? = nil, font: Font? = nil, orientation: Orientation? = nil, traceorder: Traceorder? = nil, tracegroupgap: Double? = nil, itemsizing: Itemsizing? = nil, itemclick: Itemclick? = nil, itemdoubleclick: Itemdoubleclick? = nil, x: Double? = nil, xanchor: Xanchor? = nil, y: Double? = nil, yanchor: Yanchor? = nil, uirevision: Anything? = nil, valign: Valign? = nil) {
            self.bgcolor = bgcolor
            self.bordercolor = bordercolor
            self.borderwidth = borderwidth
            self.font = font
    ...
    public struct Annotations: Encodable {
        public struct Items: Encodable {
            public struct Annotation: Encodable {
                ...
                public init(visible: Bool? = nil, text: String? = nil, textangle: Angle? = nil, font: Font? = nil, width: Double? = nil, height: Double? = nil, opacity: Double? = nil, align: Align? = nil, valign: Valign? = nil, bgcolor: Color? = nil, bordercolor: Color? = nil, borderpad: Double? = nil, borderwidth: Double? = nil, showarrow: Bool? = nil, arrowcolor: Color? = nil, arrowhead: Int? = nil, startarrowhead: Int? = nil, arrowside: Arrowside? = nil, arrowsize: Double? = nil, startarrowsize: Double? = nil, arrowwidth: Double? = nil, standoff: Double? = nil, startstandoff: Double? = nil, ax: Anything? = nil, ay: Anything? = nil, axref: Axref? = nil, ayref: Ayref? = nil, xref: Xref? = nil, x: Anything? = nil, xanchor: Xanchor? = nil, xshift: Double? = nil, yref: Yref? = nil, y: Anything? = nil, yanchor: Yanchor? = nil, yshift: Double? = nil, clicktoshow: Clicktoshow? = nil, xclick: Anything? = nil, yclick: Anything? = nil, hovertext: String? = nil, hoverlabel: Hoverlabel? = nil, captureevents: Bool? = nil, _deprecated: _Deprecated? = nil, name: String? = nil, templateitemname: String? = nil) {
                    self.visible = visible
                    self.text = text
                    self.textangle = textangle
                    self.font = font
    ...
    public struct Shapes: Encodable {
        public struct Items: Encodable {
            public struct Shape: Encodable {
                ...
                public init(visible: Bool? = nil, type: AxisType? = nil, layer: Layer? = nil, xref: Xref? = nil, xsizemode: Xsizemode? = nil, xanchor: Anything? = nil, x0: Anything? = nil, x1: Anything? = nil, yref: Yref? = nil, ysizemode: Ysizemode? = nil, yanchor: Anything? = nil, y0: Anything? = nil, y1: Anything? = nil, path: String? = nil, opacity: Double? = nil, line: Line? = nil, fillcolor: Color? = nil, name: String? = nil, templateitemname: String? = nil) {
                    self.visible = visible
                    self.type = type
                    self.layer = layer
                    self.xref = xref
    ...
    public struct Images: Encodable {
        public struct Items: Encodable {
            public struct Image: Encodable {
                ...
                public init(visible: Bool? = nil, source: String? = nil, layer: Layer? = nil, sizex: Double? = nil, sizey: Double? = nil, sizing: Sizing? = nil, opacity: Double? = nil, x: Anything? = nil, y: Anything? = nil, xanchor: Xanchor? = nil, yanchor: Yanchor? = nil, xref: Xref? = nil, yref: Yref? = nil, name: String? = nil, templateitemname: String? = nil) {
                    self.visible = visible
                    self.source = source
                    self.layer = layer
                    self.sizex = sizex
    ...
    public struct Updatemenus: Encodable {
        public struct Items: Encodable {
            public struct Updatemenu: Encodable {
                ...
                public init(visible: Bool? = nil, type: AxisType? = nil, direction: Direction? = nil, active: Int? = nil, showactive: Bool? = nil, buttons: Buttons? = nil, x: Double? = nil, xanchor: Xanchor? = nil, y: Double? = nil, yanchor: Yanchor? = nil, pad: Pad? = nil, font: Font? = nil, bgcolor: Color? = nil, bordercolor: Color? = nil, borderwidth: Double? = nil, name: String? = nil, templateitemname: String? = nil) {
                    self.visible = visible
                    self.type = type
                    self.direction = direction
                    self.active = active
    ...
    public struct Sliders: Encodable {
        public struct Items: Encodable {
            public struct Slider: Encodable {
                ...
                public var minorticklen: Double?
                ...
                public init(visible: Bool? = nil, active: Double? = nil, steps: Steps? = nil, lenmode: Lenmode? = nil, len: Double? = nil, x: Double? = nil, pad: Pad? = nil, xanchor: Xanchor? = nil, y: Double? = nil, yanchor: Yanchor? = nil, transition: Transition? = nil, currentvalue: Currentvalue? = nil, font: Font? = nil, activebgcolor: Color? = nil, bgcolor: Color? = nil, bordercolor: Color? = nil, borderwidth: Double? = nil, ticklen: Double? = nil, tickcolor: Color? = nil, tickwidth: Double? = nil, minorticklen: Double? = nil, name: String? = nil, templateitemname: String? = nil) {
                    self.visible = visible
                    self.active = active
                    self.steps = steps
    ...
    public struct Coloraxis: Encodable {
        ...
        public init(cauto: Bool? = nil, cmin: Double? = nil, cmax: Double? = nil, cmid: Double? = nil, colorscale: ColorScale? = nil, autocolorscale: Bool? = nil, reversescale: Bool? = nil, showscale: Bool? = nil, colorbar: Colorbar? = nil) {
            self.cauto = cauto
            self.cmin = cmin
            self.cmax = cmax
            self.cmid = cmid
    ...
    public init(font: Font? = nil, title: Title? = nil, autosize: Bool? = nil, width: Double? = nil, height: Double? = nil, margin: Margin? = nil, paper_bgcolor: Color? = nil, plot_bgcolor: Color? = nil, separators: String? = nil, hidesources: Bool? = nil, showlegend: Bool? = nil, colorway: ColorList? = nil, datarevision: Anything? = nil, uirevision: Anything? = nil, editrevision: Anything? = nil, selectionrevision: Anything? = nil, template: Anything? = nil, modebar: Modebar? = nil, meta: Anything? = nil, transition: Transition? = nil, _deprecated: _Deprecated? = nil, clickmode: Clickmode? = nil, dragmode: Dragmode? = nil, hovermode: Hovermode? = nil, hoverdistance: Int? = nil, spikedistance: Int? = nil, hoverlabel: Hoverlabel? = nil, selectdirection: Selectdirection? = nil, grid: Grid? = nil, calendar: Calendar? = nil, xaxis: Xaxis? = nil, yaxis: Yaxis? = nil, ternary: Ternary? = nil, scene: Scene? = nil, geo: Geo? = nil, mapbox: Mapbox? = nil, polar: Polar? = nil, radialaxis: Radialaxis? = nil, angularaxis: Angularaxis? = nil, direction: Direction? = nil, orientation: Angle? = nil, legend: Legend? = nil, annotations: Annotations? = nil, shapes: Shapes? = nil, images: Images? = nil, updatemenus: Updatemenus? = nil, sliders: Sliders? = nil, colorscale: Colorscale? = nil, coloraxis: Coloraxis? = nil, metasrc: String? = nil) {
        self.font = font
        self.title = title
