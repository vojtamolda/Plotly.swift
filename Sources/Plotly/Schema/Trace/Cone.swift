...
public struct Cone: Trace {
    ...
    public init(visible: Visible? = nil, name: String? = nil, uid: String? = nil, ids: [Double]? = nil, customdata: [Double]? = nil, meta: Anything? = nil, hoverlabel: Hoverlabel? = nil, stream: Stream? = nil, uirevision: Anything? = nil, x: [Double]? = nil, y: [Double]? = nil, z: [Double]? = nil, u: [Double]? = nil, v: [Double]? = nil, w: [Double]? = nil, sizemode: Sizemode? = nil, sizeref: Double? = nil, anchor: Anchor? = nil, text: String? = nil, hovertext: String? = nil, hovertemplate: String? = nil, cauto: Bool? = nil, cmin: Double? = nil, cmax: Double? = nil, cmid: Double? = nil, colorscale: ColorScale? = nil, autocolorscale: Bool? = nil, reversescale: Bool? = nil, showscale: Bool? = nil, colorbar: Colorbar? = nil, coloraxis: SubplotID? = nil, opacity: Double? = nil, lightposition: Lightposition? = nil, lighting: Lighting? = nil, hoverinfo: Hoverinfo? = nil, scene: SubplotID? = nil, idssrc: String? = nil, customdatasrc: String? = nil, metasrc: String? = nil, xsrc: String? = nil, ysrc: String? = nil, zsrc: String? = nil, usrc: String? = nil, vsrc: String? = nil, wsrc: String? = nil, textsrc: String? = nil, hovertextsrc: String? = nil, hovertemplatesrc: String? = nil, hoverinfosrc: String? = nil) {
