...
public struct Densitymapbox: Trace {
    ...
    public init(visible: Visible? = nil, opacity: Double? = nil, name: String? = nil, uid: String? = nil, ids: [Double]? = nil, customdata: [Double]? = nil, meta: Anything? = nil, hoverlabel: Hoverlabel? = nil, stream: Stream? = nil, transforms: Transforms? = nil, uirevision: Anything? = nil, lon: [Double]? = nil, lat: [Double]? = nil, z: [Double]? = nil, radius: Double? = nil, below: String? = nil, text: String? = nil, hovertext: String? = nil, hoverinfo: Hoverinfo? = nil, hovertemplate: String? = nil, zauto: Bool? = nil, zmin: Double? = nil, zmax: Double? = nil, zmid: Double? = nil, colorscale: ColorScale? = nil, autocolorscale: Bool? = nil, reversescale: Bool? = nil, showscale: Bool? = nil, colorbar: Colorbar? = nil, coloraxis: SubplotID? = nil, subplot: SubplotID? = nil, idssrc: String? = nil, customdatasrc: String? = nil, metasrc: String? = nil, lonsrc: String? = nil, latsrc: String? = nil, zsrc: String? = nil, radiussrc: String? = nil, textsrc: String? = nil, hovertextsrc: String? = nil, hoverinfosrc: String? = nil, hovertemplatesrc: String? = nil) {
