...
struct Choropleth: Encodable {
    let type: String = "choropleth"
    ...
    enum Locationmode: String, Encodable {
        case ISO3
        case USAstates
        case countrynames
    }
    ...
    struct Hoverinfo: OptionSet, Encodable {
        ...
        static let location = Hoverinfo(rawValue: 1 << 0)
        static let z = Hoverinfo(rawValue: 1 << 1)
