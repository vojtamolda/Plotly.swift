...
public struct Choropleth: Trace {
    ...
    public init(visible: Visible? = nil, name: String? = nil, uid: String? = nil, ids: [Double]? = nil, customdata: [Double]? = nil, meta: Anything? = nil, selectedpoints: Anything? = nil, hoverlabel: Hoverlabel? = nil, stream: Stream? = nil, transforms: Transforms? = nil, uirevision: Anything? = nil, locations: [Double]? = nil, locationmode: Locationmode? = nil, z: [Double]? = nil, text: String? = nil, hovertext: String? = nil, marker: Marker? = nil, selected: Selected? = nil, unselected: Unselected? = nil, hoverinfo: Hoverinfo? = nil, hovertemplate: String? = nil, zauto: Bool? = nil, zmin: Double? = nil, zmax: Double? = nil, zmid: Double? = nil, colorscale: ColorScale? = nil, autocolorscale: Bool? = nil, reversescale: Bool? = nil, showscale: Bool? = nil, colorbar: Colorbar? = nil, coloraxis: SubplotID? = nil, geo: SubplotID? = nil, idssrc: String? = nil, customdatasrc: String? = nil, metasrc: String? = nil, locationssrc: String? = nil, zsrc: String? = nil, textsrc: String? = nil, hovertextsrc: String? = nil, hoverinfosrc: String? = nil, hovertemplatesrc: String? = nil) {
