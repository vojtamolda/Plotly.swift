...
public struct Volume: Trace {
    ...
    public struct Slices: Encodable {
        public struct X: Encodable {
            ...
            public init(show: Bool? = nil, locations: [Double]? = nil, fill: Double? = nil, locationssrc: String? = nil) {
                self.show = show
    ...
    public init(visible: Visible? = nil, name: String? = nil, uid: String? = nil, ids: [Double]? = nil, customdata: [Double]? = nil, meta: Anything? = nil, hoverlabel: Hoverlabel? = nil, stream: Stream? = nil, uirevision: Anything? = nil, x: [Double]? = nil, y: [Double]? = nil, z: [Double]? = nil, value: [Double]? = nil, isomin: Double? = nil, isomax: Double? = nil, surface: Surface? = nil, spaceframe: Spaceframe? = nil, slices: Slices? = nil, caps: Caps? = nil, text: String? = nil, hovertext: String? = nil, hovertemplate: String? = nil, cauto: Bool? = nil, cmin: Double? = nil, cmax: Double? = nil, cmid: Double? = nil, colorscale: ColorScale? = nil, autocolorscale: Bool? = nil, reversescale: Bool? = nil, showscale: Bool? = nil, colorbar: Colorbar? = nil, coloraxis: SubplotID? = nil, opacity: Double? = nil, opacityscale: Anything? = nil, lightposition: Lightposition? = nil, lighting: Lighting? = nil, flatshading: Bool? = nil, contour: Contour? = nil, hoverinfo: Hoverinfo? = nil, scene: SubplotID? = nil, idssrc: String? = nil, customdatasrc: String? = nil, metasrc: String? = nil, xsrc: String? = nil, ysrc: String? = nil, zsrc: String? = nil, valuesrc: String? = nil, textsrc: String? = nil, hovertextsrc: String? = nil, hovertemplatesrc: String? = nil, hoverinfosrc: String? = nil) {
