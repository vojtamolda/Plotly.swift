...
struct Volume: Trace {
    ...
    struct Surface: Encodable {
        ...
        struct Pattern: OptionSet, Encodable {
            let rawValue: Int
        
            static let A = Pattern(rawValue: 1 << 0)
            static let B = Pattern(rawValue: 1 << 1)
            static let C = Pattern(rawValue: 1 << 2)
            static let D = Pattern(rawValue: 1 << 3)
            static let E = Pattern(rawValue: 1 << 4)
    ...
    var spaceframe: Spaceframe?

    struct Slices: Encodable {
        struct X: Encodable {
