...
public struct Scatterpolargl: Trace {
    ...
    public init(visible: Visible? = nil, showlegend: Bool? = nil, legendgroup: String? = nil, opacity: Double? = nil, name: String? = nil, uid: String? = nil, ids: [Double]? = nil, customdata: [Double]? = nil, meta: Anything? = nil, selectedpoints: Anything? = nil, hoverlabel: Hoverlabel? = nil, stream: Stream? = nil, transforms: Transforms? = nil, uirevision: Anything? = nil, mode: Mode? = nil, r: [Double]? = nil, theta: [Double]? = nil, r0: Anything? = nil, dr: Double? = nil, theta0: Anything? = nil, dtheta: Double? = nil, thetaunit: Thetaunit? = nil, text: String? = nil, texttemplate: String? = nil, hovertext: String? = nil, hovertemplate: String? = nil, line: Line? = nil, connectgaps: Bool? = nil, marker: Marker? = nil, fill: Fill? = nil, fillcolor: Color? = nil, textposition: Textposition? = nil, textfont: Textfont? = nil, hoverinfo: Hoverinfo? = nil, selected: Selected? = nil, unselected: Unselected? = nil, subplot: SubplotID? = nil, idssrc: String? = nil, customdatasrc: String? = nil, metasrc: String? = nil, rsrc: String? = nil, thetasrc: String? = nil, textsrc: String? = nil, texttemplatesrc: String? = nil, hovertextsrc: String? = nil, hovertemplatesrc: String? = nil, textpositionsrc: String? = nil, hoverinfosrc: String? = nil) {
