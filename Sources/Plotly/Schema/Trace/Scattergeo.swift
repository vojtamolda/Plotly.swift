...
public struct Scattergeo: Trace {
    ...
    public struct Marker: Encodable {
        ...
        public init(symbol: Symbol? = nil, opacity: Double? = nil, size: Double? = nil, sizeref: Double? = nil, sizemin: Double? = nil, sizemode: Sizemode? = nil, colorbar: Colorbar? = nil, line: Line? = nil, gradient: Gradient? = nil, color: Color? = nil, cauto: Bool? = nil, cmin: Double? = nil, cmax: Double? = nil, cmid: Double? = nil, colorscale: ColorScale? = nil, autocolorscale: Bool? = nil, reversescale: Bool? = nil, showscale: Bool? = nil, coloraxis: SubplotID? = nil, symbolsrc: String? = nil, opacitysrc: String? = nil, sizesrc: String? = nil, colorsrc: String? = nil) {
            self.symbol = symbol
    ...
    public var lonsrc: String?

    /// Sets the source reference on plot.ly for  lat .
    public var latsrc: String?

    /// Sets the source reference on plot.ly for  locations .
    public var locationssrc: String?
    ...
    public init(visible: Visible? = nil, showlegend: Bool? = nil, legendgroup: String? = nil, opacity: Double? = nil, name: String? = nil, uid: String? = nil, ids: [Double]? = nil, customdata: [Double]? = nil, meta: Anything? = nil, selectedpoints: Anything? = nil, hoverlabel: Hoverlabel? = nil, stream: Stream? = nil, transforms: Transforms? = nil, uirevision: Anything? = nil, lon: [Double]? = nil, lat: [Double]? = nil, locations: [Double]? = nil, locationmode: Locationmode? = nil, mode: Mode? = nil, text: String? = nil, texttemplate: String? = nil, hovertext: String? = nil, textfont: Textfont? = nil, textposition: Textposition? = nil, line: Line? = nil, connectgaps: Bool? = nil, marker: Marker? = nil, fill: Fill? = nil, fillcolor: Color? = nil, selected: Selected? = nil, unselected: Unselected? = nil, hoverinfo: Hoverinfo? = nil, hovertemplate: String? = nil, geo: SubplotID? = nil, idssrc: String? = nil, customdatasrc: String? = nil, metasrc: String? = nil, lonsrc: String? = nil, latsrc: String? = nil, locationssrc: String? = nil, textsrc: String? = nil, texttemplatesrc: String? = nil, hovertextsrc: String? = nil, textpositionsrc: String? = nil, hoverinfosrc: String? = nil, hovertemplatesrc: String? = nil) {
