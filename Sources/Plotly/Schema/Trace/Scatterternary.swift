...
public struct Scatterternary: Trace {
    ...
    public init(visible: Visible? = nil, showlegend: Bool? = nil, legendgroup: String? = nil, opacity: Double? = nil, name: String? = nil, uid: String? = nil, ids: [Double]? = nil, customdata: [Double]? = nil, meta: Anything? = nil, selectedpoints: Anything? = nil, hoverlabel: Hoverlabel? = nil, stream: Stream? = nil, transforms: Transforms? = nil, uirevision: Anything? = nil, a: [Double]? = nil, b: [Double]? = nil, c: [Double]? = nil, sum: Double? = nil, mode: Mode? = nil, text: String? = nil, texttemplate: String? = nil, hovertext: String? = nil, line: Line? = nil, connectgaps: Bool? = nil, cliponaxis: Bool? = nil, fill: Fill? = nil, fillcolor: Color? = nil, marker: Marker? = nil, textfont: Textfont? = nil, textposition: Textposition? = nil, selected: Selected? = nil, unselected: Unselected? = nil, hoverinfo: Hoverinfo? = nil, hoveron: Hoveron? = nil, hovertemplate: String? = nil, subplot: SubplotID? = nil, idssrc: String? = nil, customdatasrc: String? = nil, metasrc: String? = nil, asrc: String? = nil, bsrc: String? = nil, csrc: String? = nil, textsrc: String? = nil, texttemplatesrc: String? = nil, hovertextsrc: String? = nil, textpositionsrc: String? = nil, hoverinfosrc: String? = nil, hovertemplatesrc: String? = nil) {
