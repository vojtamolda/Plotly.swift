...
public struct Heatmap: Trace {
    ...
    public init(visible: Visible? = nil, opacity: Double? = nil, name: String? = nil, uid: String? = nil, ids: [Double]? = nil, customdata: [Double]? = nil, meta: Anything? = nil, hoverinfo: Hoverinfo? = nil, hoverlabel: Hoverlabel? = nil, stream: Stream? = nil, transforms: Transforms? = nil, uirevision: Anything? = nil, z: [Double]? = nil, x: [Double]? = nil, x0: Anything? = nil, dx: Double? = nil, y: [Double]? = nil, y0: Anything? = nil, dy: Double? = nil, text: [Double]? = nil, hovertext: [Double]? = nil, transpose: Bool? = nil, xtype: Xtype? = nil, ytype: Ytype? = nil, zsmooth: Zsmooth? = nil, hoverongaps: Bool? = nil, connectgaps: Bool? = nil, xgap: Double? = nil, ygap: Double? = nil, zhoverformat: String? = nil, hovertemplate: String? = nil, zauto: Bool? = nil, zmin: Double? = nil, zmax: Double? = nil, zmid: Double? = nil, colorscale: ColorScale? = nil, autocolorscale: Bool? = nil, reversescale: Bool? = nil, showscale: Bool? = nil, colorbar: Colorbar? = nil, coloraxis: SubplotID? = nil, xcalendar: Xcalendar? = nil, ycalendar: Ycalendar? = nil, xaxis: SubplotID? = nil, yaxis: SubplotID? = nil, idssrc: String? = nil, customdatasrc: String? = nil, metasrc: String? = nil, hoverinfosrc: String? = nil, zsrc: String? = nil, xsrc: String? = nil, ysrc: String? = nil, textsrc: String? = nil, hovertextsrc: String? = nil, hovertemplatesrc: String? = nil) {
