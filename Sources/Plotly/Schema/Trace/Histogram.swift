...
public struct Histogram: Trace {
    ...
    public init(visible: Visible? = nil, showlegend: Bool? = nil, legendgroup: String? = nil, opacity: Double? = nil, name: String? = nil, uid: String? = nil, ids: [Double]? = nil, customdata: [Double]? = nil, meta: Anything? = nil, selectedpoints: Anything? = nil, hoverinfo: Hoverinfo? = nil, hoverlabel: Hoverlabel? = nil, stream: Stream? = nil, transforms: Transforms? = nil, uirevision: Anything? = nil, x: [Double]? = nil, y: [Double]? = nil, text: String? = nil, hovertext: String? = nil, orientation: Orientation? = nil, histfunc: Histfunc? = nil, histnorm: Histnorm? = nil, cumulative: Cumulative? = nil, nbinsx: Int? = nil, xbins: Xbins? = nil, nbinsy: Int? = nil, ybins: Ybins? = nil, autobinx: Bool? = nil, autobiny: Bool? = nil, bingroup: String? = nil, hovertemplate: String? = nil, marker: Marker? = nil, offsetgroup: String? = nil, alignmentgroup: String? = nil, selected: Selected? = nil, unselected: Unselected? = nil, _deprecated: _Deprecated? = nil, error_x: Error_X? = nil, error_y: Error_Y? = nil, xcalendar: Xcalendar? = nil, ycalendar: Ycalendar? = nil, xaxis: SubplotID? = nil, yaxis: SubplotID? = nil, idssrc: String? = nil, customdatasrc: String? = nil, metasrc: String? = nil, hoverinfosrc: String? = nil, xsrc: String? = nil, ysrc: String? = nil, textsrc: String? = nil, hovertextsrc: String? = nil, hovertemplatesrc: String? = nil) {
        self.visible = visible
