...
struct Funnel: Encodable {
    ...
    struct Hoverinfo: OptionSet, Encodable {
        ...
        static let percentinitial = Hoverinfo(rawValue: 1 << 4)
        static let percentprevious = Hoverinfo(rawValue: 1 << 5)
        static let percenttotal = Hoverinfo(rawValue: 1 << 6)
    ...
    struct Textinfo: OptionSet, Encodable {
        ...
        static let percentinitial = Textinfo(rawValue: 1 << 2)
        static let percentprevious = Textinfo(rawValue: 1 << 3)
        static let percenttotal = Textinfo(rawValue: 1 << 4)
        static let value = Textinfo(rawValue: 1 << 5)
