...
public struct Mesh3D: Trace {
    ...
    public var jsrc: String?

    /// Sets the source reference on plot.ly for  k .
    public var ksrc: String?
    ...
    public var intensitysrc: String?

    /// Sets the source reference on plot.ly for  vertexcolor .
    public var vertexcolorsrc: String?

    /// Sets the source reference on plot.ly for  facecolor .
    public var facecolorsrc: String?

    /// Sets the source reference on plot.ly for  hoverinfo .
    public var hoverinfosrc: String?

    public init(visible: Visible? = nil, name: String? = nil, uid: String? = nil, ids: [Double]? = nil, customdata: [Double]? = nil, meta: Anything? = nil, hoverlabel: Hoverlabel? = nil, stream: Stream? = nil, uirevision: Anything? = nil, x: [Double]? = nil, y: [Double]? = nil, z: [Double]? = nil, i: [Double]? = nil, j: [Double]? = nil, k: [Double]? = nil, text: String? = nil, hovertext: String? = nil, hovertemplate: String? = nil, delaunayaxis: Delaunayaxis? = nil, alphahull: Double? = nil, intensity: [Double]? = nil, color: Color? = nil, vertexcolor: [Double]? = nil, facecolor: [Double]? = nil, cauto: Bool? = nil, cmin: Double? = nil, cmax: Double? = nil, cmid: Double? = nil, colorscale: ColorScale? = nil, autocolorscale: Bool? = nil, reversescale: Bool? = nil, showscale: Bool? = nil, colorbar: Colorbar? = nil, coloraxis: SubplotID? = nil, opacity: Double? = nil, flatshading: Bool? = nil, contour: Contour? = nil, lightposition: Lightposition? = nil, lighting: Lighting? = nil, hoverinfo: Hoverinfo? = nil, xcalendar: Xcalendar? = nil, ycalendar: Ycalendar? = nil, zcalendar: Zcalendar? = nil, scene: SubplotID? = nil, idssrc: String? = nil, customdatasrc: String? = nil, metasrc: String? = nil, xsrc: String? = nil, ysrc: String? = nil, zsrc: String? = nil, isrc: String? = nil, jsrc: String? = nil, ksrc: String? = nil, textsrc: String? = nil, hovertextsrc: String? = nil, hovertemplatesrc: String? = nil, intensitysrc: String? = nil, vertexcolorsrc: String? = nil, facecolorsrc: String? = nil, hoverinfosrc: String? = nil) {
